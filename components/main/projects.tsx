...
export const Projects = () => {
  ...
  return (
    <section id="projects" className="overflow-x-hidden py-20 px-4 sm:px-6 ">
      {/* TITLE */}
   <motion.div
...
>
  ...
  <p className="text-gray-400 mt-4 max-w-lg mx-auto text-sm md:text-base tracking-wide opacity-80 px-4">
    Digital <span className="text-white font-medium">constellations</span> crafted with precision and modern code.
  </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          {PROJECT_DATA.map((project, index) => (
            ...
            >
              <h3 className={`font-semibold transition-colors ${active.title === project.title ? "text-cyan-400" : "text-white"}`}>
                {project.title}
              </h3>
